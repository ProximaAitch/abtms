...
class HealthEmailVerification extends StatefulWidget {
  const HealthEmailVerification({super.key});

  @override
  _HealthEmailVerificationState createState() =>
      _HealthEmailVerificationState();
}

class _HealthEmailVerificationState extends State<HealthEmailVerification> {
