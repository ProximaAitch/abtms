...
class _EditPatientProfileState extends State<EditPatientProfile> {
  ...
  Future<void> fetchUserProfile() async {
    PatientAuthService authService = PatientAuthService();
    print("Fetching user profile...");
    Map<String, dynamic>? userProfile = await authService.fetchUserProfile();
  ...
  Future<void> _pickImage(ImageSource source) async {
    try {
      ...
      if (pickedFile != null) {
        ...
        await PatientAuthService().updateProfileImage(pickedFile);
              ...
              children: <Widget>[
                ...
                ListTile(
                  ...
                  onTap: () async {
                    ...
                    await PatientAuthService().updateProfileImage(null);
                    if (mounted) {}
                    Navigator.of(context).pop();
                  },
                ),
